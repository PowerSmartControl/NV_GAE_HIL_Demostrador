...
#
# Generated by export_simulation on Fri Jun 15 17:28:22 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './NV_project.sh' script.

./NV_project.sh -reset_run
...
./NV_project.sh -noclean_files

For more information on the script, please type './NV_project.sh -help'.
