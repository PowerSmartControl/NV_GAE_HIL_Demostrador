...
HD_PWD='C:/Users/Jorge/Documents/GitHub/nvHIL/Vivado/NV_project/NV_project/NV_project.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log NV_project_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NV_project_wrapper.tcl -notrace
