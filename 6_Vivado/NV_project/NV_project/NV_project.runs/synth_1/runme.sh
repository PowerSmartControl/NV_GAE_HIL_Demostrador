...
HD_PWD='C:/Users/Jorge/Documents/GitHub/nvHIL/Vivado/NV_project/NV_project/NV_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NV_project_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NV_project_wrapper.tcl
