...
int Pi, t_step_C, dt_L1, dt_L2, dt_C, rC, Counter_limit, Ampl_a, Ampl_b, Ampl_c, Lgrid, phase_step_on, phase_step, ret_sel_marcha, sp6, sp7, sp8, sp9, sp10, sp11, sp12=0;
//IP NV_IO_CONTROLLER
...
int DC_bus_fixed_volt, rL1, rL2, inv_seq, DC_bus_fived, mode_igbt_input, sp1;
//parameter load 2
...
int rL2_real, rL1_real, Preload, ena_chop_res;
int I_in, Fan_speed;
...
int manual_or_console=0;	//1=>NV console / 0=>manual (serie terminal)
...
int main()
{
	...
	t_step_C=10;
	dt_L1=13;			//AP_16_1
	dt_L2=66;//(600uH)		655;			//AP_16_1
	dt_C=131;			//AP_16_1
	rC=512;				//AP_31_21
	Counter_limit=199;//380;	//AP_16_15
	...
	NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 40, I_in);
	...
	rL2_real=13;//13;//200;//2;			//AP_30_23
	Preload=1408;//200;//1408;//(11ohm)		640;			//AP_32_25
	ena_chop_res=0;		//bool
	rL1_real=1;			//spare / unused
	sp_2_4=0;
	sp_2_5=0;
	sp_2_6=0;
	sp_2_7=0;
	...
	PARAMETER_LOAD_2_mWriteReg (AXI_NV_PARAMETER_LOAD_2_BASEADDR,  16, sp_2_4);
	...
	for (;;){
		...
		if (manual_or_console==1){	//mode console
			...
			//NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR,  0, Pi);
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR,  4, auxxxx);//j_C_bus_dc);//*0.735);
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR,  8, j_L1);
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 12, j_L2);
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 16, j_C);
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 20, j_rC);
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 24, j_freq_grid);
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 28, j_Ampl_a);
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 32, j_Ampl_b);
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 36, j_Ampl_c);
			...
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 48, j_phaseStep);
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 52, j_V_bus_voltage);
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 56, j_rL1);
			...
			//			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 72, ret_sel_marcha);
			NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 76, 1);//mode_igbt_input);
			...
			// NV_PARAMETER_LOAD_2
			PARAMETER_LOAD_2_mWriteReg (AXI_NV_PARAMETER_LOAD_2_BASEADDR,  0, j_rL2+300);
			PARAMETER_LOAD_2_mWriteReg (AXI_NV_PARAMETER_LOAD_2_BASEADDR,  4, j_rPrecarga);
			//			PARAMETER_LOAD_2_mWriteReg (AXI_NV_PARAMETER_LOAD_2_BASEADDR,  8, ena_chop_res);
			//			PARAMETER_LOAD_2_mWriteReg (AXI_NV_PARAMETER_LOAD_2_BASEADDR,  12, sp_2_3);
			//			PARAMETER_LOAD_2_mWriteReg (AXI_NV_PARAMETER_LOAD_2_BASEADDR,  16, sp_2_4);
			//			PARAMETER_LOAD_2_mWriteReg (AXI_NV_PARAMETER_LOAD_2_BASEADDR,  20, sp_2_5);
			//			PARAMETER_LOAD_2_mWriteReg (AXI_NV_PARAMETER_LOAD_2_BASEADDR,  24, sp_2_6);
			//			PARAMETER_LOAD_2_mWriteReg (AXI_NV_PARAMETER_LOAD_2_BASEADDR,  28, sp_2_7);
			...
			printf("t_step_C:                                                        \t %-10d choose-> 2\n", t_step_C);
			printf("dt_L1:                                                           \t %-10d choose-> 3\n", dt_L1);
			printf("dt_L2:                                                           \t %-10d choose-> 4\n", dt_L2);
			printf("dt_C:                                                            \t %-10d choose-> 5\n", dt_C);
			printf("rC:                                                              \t %-10d choose-> 6\n", rC);
			printf("Counter_limit (grid freq):                                       \t %-10d choose-> 7\n", Counter_limit);
			printf("Ampl_a:                                                          \t %-10d choose-> 8\n", Ampl_a);
			printf("Ampl_b:                                                          \t %-10d choose-> 9\n", Ampl_b);
			printf("Ampl_c:                                                          \t %-10d choose->10\n", Ampl_c);
			printf("I in dc bus:                                                           \t %-10d choose->11\n", Lgrid);
			printf("phase_step_on (1=> on):                                          \t %-10d choose->12\n", phase_step_on);
			printf("phase_step:                                                      \t %-10d choose->13\n", phase_step);
			printf("DC_bus_fixed_voltage (in volts):                                 \t %-10d choose->14\n", DC_bus_fixed_volt);
			...
			//parameter_load_2
			printf("rL2:                                                             \t %-10d choose->21\n", rL2_real);
			printf("Preload:                                                         \t %-10d choose->22\n", Preload);
			printf("rL1:                                                             \t %-10d choose->24\n", rL1_real);
		...
		printf("potDig_output_value_4 (0 to 1023):                      \t\t\t%i\t\tchoose->330\n", potDig_output_value_4);
			...
			case 19:{
				mode_igbt_input=aux_2;
				NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 76, mode_igbt_input);
			}
			break;

			case 20:{
				ret_sel_marcha=aux_2;
				NV_PARAMETER_LOAD_mWriteReg (AXI_NV_PARAMETER_LOAD_BASEADDR, 72, ret_sel_marcha);
			}
			break;
