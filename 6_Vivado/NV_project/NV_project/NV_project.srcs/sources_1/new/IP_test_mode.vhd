       ...
       begin
           if RST='0' then
               ...
               if (mode='0') then   --normal mode
                    ...
                    if mode_dac='1' then        --this mode is used to write directly to dac registers
                    
                        analog_output_1  <= analog_output_TEST_1 ;
                        analog_output_2  <= analog_output_TEST_2 ;
                        analog_output_3  <= analog_output_TEST_3 ;
                        analog_output_4  <= analog_output_TEST_4 ;
                        analog_output_5  <= analog_output_TEST_5 ;
                        analog_output_6  <= analog_output_TEST_6 ;
                        analog_output_7  <= analog_output_TEST_7 ;
                        analog_output_8  <= analog_output_TEST_8 ;
                        analog_output_9  <= analog_output_TEST_9 ;
                        analog_output_10 <= analog_output_TEST_10;
                        analog_output_11 <= analog_output_TEST_11;
                        analog_output_12 <= analog_output_TEST_12;
                        analog_output_13 <= analog_output_TEST_13;
                        analog_output_14 <= analog_output_TEST_14;
                        analog_output_15 <= analog_output_TEST_15;
                        analog_output_16 <= analog_output_TEST_16; 
                        analog_output_17 <= analog_output_TEST_17;
                    
                    else                                --this mode generates a saw thooth for checking dac behaviour
                    
                        if (value_analog_output_1=0) then
                            incr_1<='1';
                        elsif (value_analog_output_1=to_integer(unsigned(analog_output_TEST_1))) then
                            incr_1<='0';
                        end if;                    
                        if (incr_1='1') then
                        ...
                        if (value_analog_output_2=0) then
                            incr_2<='1';
                        elsif (value_analog_output_2=to_integer(unsigned(analog_output_TEST_2))) then
                            incr_2<='0';
                        end if;                    
                        if (incr_2='1') then
                        ...
                        if (value_analog_output_3=0) then
                            incr_3<='1';
                        elsif (value_analog_output_3=to_integer(unsigned(analog_output_TEST_3))) then
                            incr_3<='0';
                        end if;                    
                        if (incr_3='1') then
                        ...
                        if (value_analog_output_4=0) then
                            incr_4<='1';
                        elsif (value_analog_output_4=to_integer(unsigned(analog_output_TEST_4))) then
                            incr_4<='0';
                        end if;                    
                        if (incr_4='1') then
                        ...
                        if (value_analog_output_5=0) then
                            incr_5<='1';
                        elsif (value_analog_output_5=to_integer(unsigned(analog_output_TEST_5))) then
                            incr_5<='0';
                        end if;                    
                        if (incr_5='1') then
                        ...
                        if (value_analog_output_6=0) then
                            incr_6<='1';
                        elsif (value_analog_output_6=to_integer(unsigned(analog_output_TEST_6))) then
                            incr_6<='0';
                        end if;                    
                        if (incr_6='1') then
                        ...
                        if (value_analog_output_7=0) then
                            incr_7<='1';
                        elsif (value_analog_output_7=to_integer(unsigned(analog_output_TEST_7))) then
                            incr_7<='0';
                        end if;                    
                        if (incr_7='1') then
                        ...
                        if (value_analog_output_8=0) then
                            incr_8<='1';
                        elsif (value_analog_output_8=to_integer(unsigned(analog_output_TEST_8))) then
                            incr_8<='0';
                        end if;                    
                        if (incr_8='1') then
                        ...
                        if (value_analog_output_9=0) then
                            incr_9<='1';
                        elsif (value_analog_output_9=to_integer(unsigned(analog_output_TEST_9))) then
                            incr_9<='0';
                        end if;                    
                        if (incr_9='1') then
                        ...
                        if (value_analog_output_10=0) then
                            incr_10<='1';
                        elsif (value_analog_output_10=to_integer(unsigned(analog_output_TEST_10))) then
                            incr_10<='0';
                        end if;                    
                        if (incr_10='1') then
                        ...
                        if (value_analog_output_11=0) then
                            incr_11<='1';
                        elsif (value_analog_output_11=to_integer(unsigned(analog_output_TEST_11))) then
                            incr_11<='0';
                        end if;                    
                        if (incr_11='1') then
                        ...
                        if (value_analog_output_12=0) then
                            incr_12<='1';
                        elsif (value_analog_output_12=to_integer(unsigned(analog_output_TEST_12))) then
                            incr_12<='0';
                        end if;                    
                        if (incr_12='1') then
                        ...
                        if (value_analog_output_13=0) then
                            incr_13<='1';
                        elsif (value_analog_output_13=to_integer(unsigned(analog_output_TEST_13))) then
                            incr_13<='0';
                        end if;                    
                        if (incr_13='1') then
                        ...
                        if (value_analog_output_14=0) then
                            incr_14<='1';
                        elsif (value_analog_output_14=to_integer(unsigned(analog_output_TEST_14))) then
                            incr_14<='0';
                        end if;                    
                        if (incr_14='1') then
                        ...
                        if (value_analog_output_15=0) then
                            incr_15<='1';
                        elsif (value_analog_output_15=to_integer(unsigned(analog_output_TEST_15))) then
                            incr_15<='0';
                        end if;                    
                        if (incr_15='1') then
                        ...
                        if (value_analog_output_16=0) then
                            incr_16<='1';
                        elsif (value_analog_output_16=to_integer(unsigned(analog_output_TEST_16))) then
                            incr_16<='0';
                        end if;                    
                        if (incr_16='1') then
                        ...
                        if (value_analog_output_17=0) then
                            incr_17<='1';
                        elsif (value_analog_output_17=to_integer(unsigned(analog_output_TEST_17))) then
                            incr_17<='0';
                        end if;                    
                        if (incr_17='1') then
                        ...
                        analog_output_1  <= std_logic_vector(to_unsigned(value_analog_output_1 , 12)) ;
                        analog_output_2  <= std_logic_vector(to_unsigned(value_analog_output_2 , 12)) ; 
                        analog_output_3  <= std_logic_vector(to_unsigned(value_analog_output_3 , 12)) ; 
                        analog_output_4  <= std_logic_vector(to_unsigned(value_analog_output_4 , 12)) ; 
                        analog_output_5  <= std_logic_vector(to_unsigned(value_analog_output_5 , 12)) ; 
                        analog_output_6  <= std_logic_vector(to_unsigned(value_analog_output_6 , 12)) ; 
                        analog_output_7  <= std_logic_vector(to_unsigned(value_analog_output_7 , 12)) ; 
                        analog_output_8  <= std_logic_vector(to_unsigned(value_analog_output_8 , 12)) ; 
                        analog_output_9  <= std_logic_vector(to_unsigned(value_analog_output_9 , 12)) ; 
                        analog_output_10 <= std_logic_vector(to_unsigned(value_analog_output_10, 12)) ; 
                        analog_output_11 <= std_logic_vector(to_unsigned(value_analog_output_11, 12)) ; 
                        analog_output_12 <= std_logic_vector(to_unsigned(value_analog_output_12, 12)) ; 
                        analog_output_13 <= std_logic_vector(to_unsigned(value_analog_output_13, 12)) ; 
                        analog_output_14 <= std_logic_vector(to_unsigned(value_analog_output_14, 12)) ; 
                        analog_output_15 <= std_logic_vector(to_unsigned(value_analog_output_15, 12)) ; 
                        analog_output_16 <= std_logic_vector(to_unsigned(value_analog_output_16, 12)) ; 
                        analog_output_17 <= std_logic_vector(to_unsigned(value_analog_output_17, 12)) ; 
